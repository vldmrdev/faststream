...
To add a new page to this section, simply add a new **Markdown** file to the [`docs/docs/en/howto/redis`](https://github.com/ag2ai/faststream/tree/main/docs/docs/en/howto/redis){.external-link target="_blank"} directory and update the [`navigation_template.txt`](https://github.com/ag2ai/faststream/blob/main/docs/docs/navigation_template.txt){.external-link target="_blank"} file.
